...
Fastly.prototype.uploadVCL = function (service, version, name, vcl, callback) {
    var url = '/service/' + service + '/version/' + version + '/vcl';
    this.request('POST', url, {content: vcl, name: name}, callback);
}
