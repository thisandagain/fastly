 ...
 * @callback {object}
 */
Fastly.prototype.request = function (method, url, params, callback, optHeaders) {
    var self = this;
...
Fastly.prototype.softPurge = function (host, url, callback) {
    var headers = { 'fastly-soft-purge': 1 }
    var params = { '*': url };
    this.request('PURGE', '/', params, callback, headers);
};

Fastly.prototype.softPurgeAll = function (service, callback) {
    var url = '/service/' + encodeURIComponent(service) + '/purge_all';
    var headers = { 'fastly-soft-purge': 1 };
    this.request('POST', url, undefined, callback, headers);
};
