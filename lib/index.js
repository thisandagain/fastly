...
Fastly.prototype.createDictionary = function (service, version, name, cb) {
  var url = path.join(
    '/service', encodeURIComponent(service), 'version',
    encodeURIComponent(version), 'dictionary'
  );
...
Fastly.prototype.getDictionaries = function (service, version, cb) {
  var url = path.join(
    '/service', encodeURIComponent(service), 'version',
    encodeURIComponent(version), 'dictionary'
  );
...
Fastly.prototype.getDictionary = function (service, version, name, cb) {
  var url = path.join(
    '/service', encodeURIComponent(service), 'version',
    encodeURIComponent(version), 'dictionary', encodeURIComponent(name)
  );

  this.request('GET', url, cb);
};

Fastly.prototype.createDictionaryItem = function (service, dict, item, cb) {
  var url = path.join(
    '/service', encodeURIComponent(service), 'dictionary',
    encodeURIComponent(dict), 'item'
  );

  this.request('POST', url, item, cb);
};

Fastly.prototype.getDictionaryItems = function (service, dict, cb) {
  var url = path.join(
    '/service', encodeURIComponent(service), 'dictionary',
    encodeURIComponent(dict), 'item'
  );
...
Fastly.prototype.getDictionaryItem = function (service, dict, item, cb) {
  var url = path.join(
    '/service', encodeURIComponent(service), 'dictionary',
    encodeURIComponent(dict), 'item', encodeURIComponent(item)
  );
